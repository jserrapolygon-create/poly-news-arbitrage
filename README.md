...
News-linked event-market scaffold that combines feed ingestion, market watchlists, and edge thresholds to act on information flow faster than manual workflows.

Connects external news catalysts to event-market execution while preserving dry-run testing and spend caps.

## Why This Repo Exists

Poly News Arbitrage is structured as a self-hosted wallet-connected trading project for users who want a finished operating surface from day one: TypeScript runtime, config validation, dry-run mode, structured logging, risk controls, tests, Docker support, and a startup path that always runs through `redeem-onchain-sdk`.
...
2. Start the market watcher so the bot can monitor headline arrival latency versus market repricing across breaking-news prediction markets.
...
v. 0.1.25.2026-04-07T22:27:44.630Z
